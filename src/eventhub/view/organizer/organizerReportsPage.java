 ...
 * @author hp
 */
public class organizerReportsPage extends javax.swing.JFrame {

    /**
     * Creates new form organizerDashboard
     */
    public organizerReportsPage() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(organizerReportsPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new organizerReportsPage().setVisible(true);
            }
        });
    }
